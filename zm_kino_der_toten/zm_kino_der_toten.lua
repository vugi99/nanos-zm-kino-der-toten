...
MAP_PACK_A_PUNCH = {
    location = Vector(4206.000, 194.000, -161.000),
    rotation = Rotator(0.000000, 53.999855, 0.000000),
    weapon_location = Vector(4138.574, 208.378, -78.000),
    weapon_rotation = Rotator(0.000000, 53.999855, 0.000000)
}
